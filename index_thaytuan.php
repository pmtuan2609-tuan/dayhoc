    ...
    <script id="react-app-source" type="text/plain">
        ...
        if (examId) {
            ...
            const docNotifs = React.useMemo(() => {
                return notifications.filter(n => !n.videoId);
            }, [notifications]);
            ...
            const getNotificationGradeBadge = (n) => {
                ...
                return (
                    <span className={`text-[9px] font-black uppercase px-1.5 py-0.5 rounded border shrink-0 ${colorClass}`}>
                        {label}
                    </span>
                );
            };
            ...
            const renderGradeOrHotBadge = (n, isNewest) => {
                ...
                if (!gradeBadge) {
                    return (
                        <span className="text-[9px] font-black uppercase px-1.5 py-0.5 bg-rose-500 text-white border border-rose-600 rounded shrink-0 animate-pulse flex items-center gap-0.5">
                            <Icon name="flame" size={8} className="fill-white"/> HOT
                        </span>
                    );
                }
                
                return (
                    <div className="relative w-[75px] h-[20px] shrink-0">
                        <div className="absolute inset-0 flex items-center justify-center anim-alternate-hot">
                            <span className="text-[9px] font-black uppercase px-1.5 py-0.5 bg-rose-500 text-white border border-rose-600 rounded shrink-0 flex items-center gap-0.5 w-full justify-center">
                                <Icon name="flame" size={8} className="fill-white"/> HOT
                            </span>
                        </div>
            ...
            const renderContent = () => {
                if (view === 'landing') return (
                    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-6 relative overflow-hidden font-sans selection:bg-emerald-500 selection:text-white">
                        {/* Khu vực nút điều hướng ở góc phải */}
                        <div className="absolute top-4 right-4 md:top-6 md:right-6 flex flex-col items-end gap-2.5 z-45">


                            {!adminSession.loggedIn ? (
                                <button onClick={() => { setAdminFormMode('login'); setShowAdminLogin(true); }} className="bg-white border border-slate-200/80 hover:bg-slate-100 hover:border-slate-300 text-slate-600 hover:text-slate-900 px-3.5 py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest flex items-center gap-1.5 transition-all shadow-sm backdrop-blur-md">
                                    <Icon name="lock" size={12}/>
                                    <span className="hidden sm:inline">Đăng nhập</span>
                                </button>
                            ) : (
                                <div className="relative group">
                                    <button className="bg-emerald-600 border border-emerald-700 hover:bg-emerald-700 text-white px-4 py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest flex items-center gap-1.5 transition-all shadow-md cursor-default">
                                        <span>👋</span>
                                    ...
                                    <div className="absolute right-0 top-[100%] pt-2 w-48 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-200 transform translate-y-1 group-hover:translate-y-0 z-50">
                                        <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xl p-2 flex flex-col gap-1 backdrop-blur-md">
                                            ...
                                            <button onClick={() => setShowUpdateProfile(true)} className="flex items-center gap-2 px-3 py-2 rounded-lg text-left font-bold text-[11px] md:text-xs text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all">
                                                <Icon name="user-cog" size={14} className="text-slate-500"/>
                                                Đổi thông tin
                                            </button>
                                            <button onClick={() => setShowChangePassword(true)} className="flex items-center gap-2 px-3 py-2 rounded-lg text-left font-bold text-[11px] md:text-xs text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all">
                                                <Icon name="key" size={14} className="text-slate-500"/>
                                                Đổi mật khẩu
                                            </button>
                            ...
                            <div className="relative group">
                                <button className="bg-white border border-slate-200/80 text-slate-600 hover:text-slate-900 px-4 py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest flex items-center gap-1.5 transition-all shadow-sm backdrop-blur-md cursor-default">
                                ...
                                <div className="absolute right-0 top-[100%] pt-2 w-48 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-200 transform translate-y-1 group-hover:translate-y-0 z-50">
                                    <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xl p-2 flex flex-col gap-1 backdrop-blur-md">
                                        <button onClick={() => { setMainMode('exams'); setShowMenu(true); }} className="flex items-center gap-2 px-3 py-2 rounded-lg text-left font-bold text-[11px] md:text-xs text-slate-600 hover:bg-emerald-50 hover:text-emerald-700 transition-all">
                                            <Icon name="file-text" size={14} className="text-emerald-500"/>
                                            Đề thi trực tuyến
                                        </button>
                                        <button onClick={() => { setMainMode('docs'); setShowMenu(true); }} className="flex items-center gap-2 px-3 py-2 rounded-lg text-left font-bold text-[11px] md:text-xs text-slate-600 hover:bg-indigo-50 hover:text-indigo-700 transition-all">
                                            <Icon name="book-open" size={14} className="text-indigo-500"/>
                                            Tài liệu học tập
                                        </button>
                                        <button onClick={() => { setMainMode('videos'); setShowMenu(true); }} className="flex items-center gap-2 px-3 py-2 rounded-lg text-left font-bold text-[11px] md:text-xs text-slate-600 hover:bg-pink-50 hover:text-pink-700 transition-all">
                        ...
                        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-70 pointer-events-none"></div>
                        ...
                        <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center mt-[-3vh] md:mt-[-5vh]">
                            <div className="inline-flex items-center gap-2 px-3 py-2 md:px-4 md:py-2.5 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-700 text-[10px] md:text-xs font-bold tracking-widest uppercase mb-8 md:mb-10 shadow-[0_4px_12px_rgba(16,185,129,0.08)] backdrop-blur-md">
                            ...
                            <div className="text-center mb-8 md:mb-12 w-full px-4 overflow-visible">
                                ...
                                <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-500 to-cyan-600 tracking-tighter uppercase drop-shadow-[0_4px_12px_rgba(20,184,166,0.15)] py-2 md:py-3 leading-snug mt-1 md:mt-2">
                                    MÔN TOÁN THPT <span className="font-serif italic lowercase">√x</span>
                                </h2>
                            </div>

                            {showMenu && (
                                <div className="w-full mt-6 animate-in fade-in slide-in-from-bottom-5 duration-500 z-20">
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 w-full px-2 md:px-4 max-w-6xl mx-auto">
                                        {[
                                            { id: 'tot_nghiep', label: 'TỐT NGHIỆP', desc: 'Ôn thi THPT Quốc Gia', color: 'from-rose-400 to-red-500', shape: 'shape-circle', dropShadow: 'rgba(244,63,94,0.3)', bgChar: 'T', fgChar: 'N' },
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col relative z-10">
                                                    <span className="text-sm sm:text-xl md:text-2xl font-black text-slate-800 mb-1 md:mb-2 uppercase tracking-widest">{g.label}</span>
                            ...
                            {!showMenu && (
                                <div className="w-full max-w-5xl mt-12 px-4 z-20 animate-in fade-in slide-in-from-bottom-5 duration-500">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 w-full">
                                        ...
                                        <div className="bg-white/70 border border-slate-200/80 rounded-3xl p-6 shadow-md shadow-slate-100/50 flex flex-col text-left backdrop-blur-md hover:shadow-lg transition-shadow duration-300">
                                            <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-2">
                                                <div className="p-1.5 bg-indigo-500/10 text-indigo-500 rounded-lg relative">
                                                    <span className="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
                                                    <Icon name="book-open" size={16}/>
                                                </div>
                                                <h3 className="text-xs md:text-sm font-black text-indigo-600 uppercase tracking-widest">Thông báo tài liệu mới nhất</h3>
                                            </div>
                                            <div className="space-y-3.5 flex-1 flex flex-col justify-between min-h-[150px]">
                                                <div className="space-y-3">
                                                    {currentDocNotifs.map((n, idx) => {
                                                        ...
                                                        const isNewest = docNotifs[0] && docNotifs[0].id === n.id;
                                                        return (
                                                            <div key={n.id || idx} onClick={() => handleNotificationClick(n)} className="flex gap-2.5 items-start text-xs font-medium leading-relaxed group cursor-pointer hover:bg-slate-50/50 p-1.5 rounded-xl transition-all">
                                                                ...
                                                                {renderGradeOrHotBadge(n, isNewest)}
                                                    ...
                                                    {docNotifs.length === 0 && (
                                                        <div className="text-center text-slate-400 font-bold text-xs py-4">Chưa có thông báo tài liệu nào mới.</div>
                                                    )}
                                                </div>
                                        ...
                                        <div className="bg-white/70 border border-slate-200/80 rounded-3xl p-6 shadow-md shadow-slate-100/50 flex flex-col text-left backdrop-blur-md hover:shadow-lg transition-shadow duration-300">
                                            <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-2">
                                                <div className="p-1.5 bg-pink-500/10 text-pink-500 rounded-lg relative">
                                                    <span className="relative inline-flex rounded-full h-2 w-2 bg-pink-500"></span>
                                                    <Icon name="play-circle" size={16}/>
                                                </div>
                                                <h3 className="text-xs md:text-sm font-black text-pink-600 uppercase tracking-widest">Video bài giảng mới nhất</h3>
                                            </div>
                                            <div className="space-y-3.5 flex-1 flex flex-col justify-between min-h-[150px]">
                                                <div className="space-y-3">
                                                    {currentVideoNotifs.map((n, idx) => {
                                                        const datePart = n.createdAt ? n.createdAt.substring(0, 5) : '';
                                                        const isNewest = videoNotifs[0] && videoNotifs[0].id === n.id;
                                                        return (
                                                            <div key={n.id || idx} onClick={() => handleNotificationClick(n)} className="flex gap-2.5 items-start text-xs font-medium leading-relaxed group cursor-pointer hover:bg-slate-50/50 p-1.5 rounded-xl transition-all">
                                                    ...
                                                    {videoNotifs.length === 0 && (
                                                        <div className="text-center text-slate-400 font-bold text-xs py-4">Chưa có thông báo video nào mới.</div>
                                                    )}
                                                </div>
                ...
                if (view === 'list') return (
                    <div className="min-h-screen bg-white">
                        <div className="max-w-6xl xl:max-w-7xl mx-auto p-4 md:p-8 overflow-y-auto custom-scrollbar pb-20">
                            <div className="flex justify-between items-center mb-6 md:mb-8 pt-2 md:pt-0">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-6">
                                {filteredExams.map((e, index) => {
                                    ...
                                    let modeBadge = <span className="text-[9px] md:text-[10px] font-black uppercase text-blue-600 bg-blue-50 px-2 py-1 rounded-md tracking-widest border border-blue-100 flex items-center gap-1"><Icon name="file-text" size={10}/> BÀI TẬP</span>;
                                    if (mode === 'test') modeBadge = <span className="text-[9px] md:text-[10px] font-black uppercase text-rose-600 bg-rose-50 px-2 py-1 rounded-md tracking-widest border border-rose-100 flex items-center gap-1"><Icon name="shield-alert" size={10}/> KIỂM TRA</span>;
                                    if (mode === 'practice') modeBadge = <span className="text-[9px] md:text-[10px] font-black uppercase text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md tracking-widest border border-emerald-100 flex items-center gap-1"><Icon name="dumbbell" size={10}/> LUYỆN TẬP</span>;

                                    return (
                                        <button key={e.id} onClick={() => { setCurrentExam(e); setView('form'); }} className="relative overflow-hidden bg-white p-5 md:p-6 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all flex items-center justify-between group text-left">
                                            <div className={`absolute left-0 top-0 bottom-0 w-1.5 md:w-2 bg-gradient-to-b ${color} opacity-80 group-hover:opacity-100 transition-opacity`}></div>
                                            <div className="flex items-center gap-4 md:gap-6 pl-2 md:pl-3 overflow-hidden">
                                                <div className={`w-14 h-14 md:w-16 md:h-16 shrink-0 rounded-[1rem] md:rounded-[1.25rem] bg-gradient-to-br ${color} text-white flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                                                    <Icon name="layout-list" size={24} className="md:w-7 md:h-7" strokeWidth={2.5}/>
                                                </div>
                                                <div className="overflow-hidden">
                                                    <h3 className="font-black text-slate-800 text-sm md:text-lg group-hover:text-indigo-600 transition-colors truncate mb-1.5 md:mb-2">{e.title}</h3>
                                                    <div className="flex flex-wrap gap-2">
                                                        {modeBadge}
                                                        <span className="text-[9px] md:text-[10px] font-black uppercase text-slate-500 bg-slate-100 px-2 py-1 md:px-2.5 md:py-1 rounded-md md:rounded-lg tracking-widest flex items-center gap-1"><Icon name="clock" size={10}/> {mode === 'practice' ? 'TỰ DO' : (e.duration||0) + ' PHÚT'}</span>
                                                        <span className="text-[9px] md:text-[10px] font-black uppercase text-slate-500 bg-slate-100 px-2 py-1 md:px-2.5 md:py-1 rounded-md md:rounded-lg tracking-widest flex items-center gap-1"><Icon name="list-checks" size={10}/> {(e.config?.p1||0)+(e.config?.p2||0)+(e.config?.p3||0)} CÂU</span>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <div className="shrink-0 flex items-center gap-2 mr-1">
                                                <span className="hidden sm:block text-[11px] font-black text-emerald-500 uppercase tracking-widest group-hover:text-emerald-600 transition-colors">VÀO LÀM</span>
                                                <div className="w-10 h-10 rounded-full bg-emerald-50 flex items-center justify-center group-hover:bg-emerald-500 group-hover:text-white text-emerald-500 transition-colors shadow-sm">
                                    ...
                                    <div className={`q-card !border-2 transition-all duration-300 ${practiceStatus === 'correct' ? '!border-emerald-500 !bg-emerald-50/50 !shadow-[0_0_30px_rgba(16,185,129,0.15)]' : practiceStatus === 'wrong' ? '!border-rose-500 animate-shake' : '!border-white'}`}>
                                        ...
                                        {currentQ.part === 'p1' && (
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                {(Array.isArray(currentQ?.q?.opts) ? currentQ.q.opts : Object.values(currentQ?.q?.opts || {})).map((opt, k) => {
                                                    ...
                                                    return (
                                                        <button key={char} disabled={practiceStatus === 'correct'} onClick={() => handleAns('p1', currentQ.idx, char)} className={`flex items-start gap-3 md:gap-4 p-4 md:p-5 rounded-xl md:rounded-2xl border-2 text-left ${btnCls}`}>
                                        ...
                                        {currentQ.part === 'p3' && (
                                            <div className="sm:pl-[3.5rem] md:pl-[4.5rem]">
                                                <input type="text" disabled={practiceStatus === 'correct'} placeholder="Nhập đáp số của bạn..." className="w-full max-w-sm bg-slate-50 p-4 md:p-5 rounded-xl md:rounded-2xl border-2 border-slate-200 font-bold text-emerald-600 text-base md:text-lg outline-none focus:border-emerald-500 focus:bg-white shadow-inner uppercase transition-all placeholder:text-sm placeholder:font-medium" value={answers?.p3?.[currentQ.idx] || ''} onChange={e => handleAns('p3', currentQ.idx, e.target.value)} />
                                            </div>
                                        )}
                                        ...
                                        {practiceStatus === 'correct' && currentQ?.q?.explain && (
                                            <div className="mt-8 pt-6 border-t-2 border-dashed border-emerald-200 animate-in fade-in slide-in-from-bottom-4">
                                                <div className="text-sm font-black text-emerald-600 tracking-widest mb-4 flex items-center gap-2">
                                                    <Icon name="check-circle" size={18}/> CHÍNH XÁC! LỜI GIẢI CHI TIẾT
                                                </div>
                ...
                <React.Fragment>
                    <div className="relative min-h-screen">
                        ...
                        {view !== 'quiz' && view !== 'review' && (
                            <div className="fixed bottom-1.5 left-0 right-0 flex justify-center pointer-events-none z-[60]">
                                <div className="px-6 py-1">
                                    <p className="text-slate-400/60 font-semibold text-[8px] uppercase tracking-widest whitespace-nowrap drop-shadow-sm">
                        ...
                        {showAdminLogin && (
                            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                                <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-md" onClick={() => setShowAdminLogin(false)}></div>
                                <div className="relative bg-slate-900 w-full max-w-sm rounded-[2rem] shadow-2xl flex flex-col overflow-hidden border border-white/10 backdrop-blur-xl animate-in zoom-in duration-300">
                                    <header className="p-5 border-b border-white/10 flex justify-between items-center bg-slate-950 text-white shrink-0">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <h2 className="text-sm font-black uppercase tracking-widest text-blue-400">
                                                {adminFormMode === 'login' ? 'Đăng nhập Quản trị' : 'Đăng ký Quản trị'}
                                            </h2>
                                        </div>
                                        <button type="button" onClick={() => setShowAdminLogin(false)} className="w-8 h-8 flex items-center justify-center bg-slate-800 text-white hover:bg-rose-600 rounded-lg transition-colors shadow-md"><Icon name="x" size={18}/></button>
                                    </header>
                                    
                                    {adminFormMode === 'login' ? (
                                        <form className="p-6 md:p-8 space-y-6 text-center animate-in fade-in duration-300" onSubmit={async (e) => {
                                            e.preventDefault();
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    ...
                                                    <input name="username" placeholder="Nhập tài khoản quản trị..." className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all text-center text-sm animate-none" required />
                                                </div>
                                                <div>
                                                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Mật khẩu</label>
                                                    <input name="password" type="password" placeholder="••••••••" className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all text-center text-sm animate-none" required />
                                                </div>
                                            </div>
                                            
                                            <button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-4 rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 hover:-translate-y-0.5 transition-all text-xs">
                                                ĐĂNG NHẬP HỆ THỐNG
                                            </button>
                                            
                                            <button type="button" onClick={() => setAdminFormMode('register')} className="text-[10px] font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest block mx-auto mt-2">
                                        ...
                                        <form className="p-6 md:p-8 space-y-6 text-center animate-in fade-in duration-300" onSubmit={async (e) => {
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Họ và Tên Giáo viên</label>
                                                    <input name="fullName" placeholder="Nhập họ và tên..." className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-emerald-500 transition-all text-center text-sm animate-none" required />
                                                </div>
                                                <div>
                                                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Tên đăng nhập mới</label>
                                                    <input name="username" placeholder="Nhập tài khoản đăng ký..." className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-emerald-500 transition-all text-center text-sm animate-none" required />
                                                </div>
                                                <div>
                                                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Mật khẩu mới</label>
                                                    <input name="password" type="password" placeholder="••••••••" className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-emerald-500 transition-all text-center text-sm animate-none" required />
                                                </div>
                                            </div>
                                            
                                            <button type="submit" className="w-full bg-gradient-to-r from-emerald-600 to-teal-500 text-white p-4 rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 hover:-translate-y-0.5 transition-all text-xs">
                                                ĐĂNG KÝ TÀI KHOẢN
                                            </button>
                                            
                                            <button type="button" onClick={() => setAdminFormMode('login')} className="text-[10px] font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest block mx-auto mt-2">
                                                Quay lại Đăng nhập
                                            </button>
                                        </form>
                                    )}
                        ...
                        {showChangePassword && (
                            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                                <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-md" onClick={() => setShowChangePassword(false)}></div>
                                <div className="relative bg-slate-900 w-full max-w-sm rounded-[2rem] shadow-2xl flex flex-col overflow-hidden border border-white/10 backdrop-blur-xl animate-in zoom-in duration-300">
                                    <header className="p-5 border-b border-white/10 flex justify-between items-center bg-slate-950 text-white shrink-0">
                                        <div className="flex items-center gap-3">
                                            <div className="p-2 bg-blue-500/20 text-blue-400 rounded-lg">
                                        ...
                                        <button type="button" onClick={() => setShowChangePassword(false)} className="w-8 h-8 flex items-center justify-center bg-slate-800 text-white hover:bg-rose-600 rounded-lg transition-colors shadow-md"><Icon name="x" size={18}/></button>
                                    </header>
                                    <form className="p-6 md:p-8 space-y-6 text-center animate-in fade-in duration-300" onSubmit={async (e) => {
                                        e.preventDefault();
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Mật khẩu cũ</label>
                                                <input name="oldPassword" type="password" placeholder="••••••••" className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all text-center text-sm" required />
                                            </div>
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Mật khẩu mới</label>
                                                <input name="newPassword" type="password" placeholder="••••••••" className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all text-center text-sm" required />
                                            </div>
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest text-left mb-1.5 ml-1">Xác nhận mật khẩu mới</label>
                                                <input name="confirmPassword" type="password" placeholder="••••••••" className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all text-center text-sm" required />
                                            </div>
                                        </div>
                                        <button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-4 rounded-2xl font-black uppercase tracking-widest hover:shadow-lg transition-all text-xs md:text-sm">Xác nhận</button>
                                    </form>
                                </div>
                            </div>
                        )}
                        {showUpdateProfile && (
                            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                                <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-md" onClick={() => setShowUpdateProfile(false)}></div>
                                <div className="relative bg-slate-900 w-full max-w-sm rounded-[2rem] shadow-2xl flex flex-col overflow-hidden border border-white/10 backdrop-blur-xl animate-in zoom-in duration-300">
                                    <header className="p-5 border-b border-white/10 flex justify-between items-center bg-slate-950 text-white shrink-0">
                                        <div className="flex items-center gap-3">
                                            <div className="p-2 bg-blue-500/20 text-blue-400 rounded-lg">
                                        ...
                                        <button type="button" onClick={() => setShowUpdateProfile(false)} className="w-8 h-8 flex items-center justify-center bg-slate-800 text-white hover:bg-rose-600 rounded-lg transition-colors shadow-md"><Icon name="x" size={18}/></button>
                                    </header>
                                    <form className="p-6 md:p-8 space-y-6 text-center animate-in fade-in duration-300" onSubmit={async (e) => {
                                        e.preventDefault();
                                        const fullName = e.target.fullName.value;
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <input name="fullName" placeholder="Nhập họ và tên..." defaultValue={adminSession.fullName} className="w-full bg-slate-950 border border-white/10 text-white placeholder:text-slate-600 p-4 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all text-center text-sm" required />
                                            </div>
                                        </div>
                                        <button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-4 rounded-2xl font-black uppercase tracking-widest hover:shadow-lg transition-all text-xs md:text-sm">Xác nhận</button>
                                    </form>
                        ...
                        {selectedPdf && (
                            <div className="fixed inset-0 z-[100] bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-2 md:p-6 animate-in fade-in duration-300">
                        ...
                        {selectedVideo && (() => {
                            ...
                            return (
                                <div className="fixed inset-0 z-[100] bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-2 md:p-6 animate-in fade-in duration-300">
                                    <div className="bg-slate-900 w-full max-w-4xl rounded-[2rem] shadow-2xl flex flex-col overflow-hidden relative border border-slate-800">
                                        <header className="p-3 md:p-4 border-b border-white/5 bg-slate-950 flex justify-between items-center shrink-0">
                                            ...
                                            <button onClick={() => setSelectedVideo(null)} className="px-3.5 py-2 bg-rose-600 text-white rounded-xl hover:bg-rose-700 transition-all text-xs font-black uppercase tracking-widest flex items-center gap-1 shadow-md">
